...
namespace EmployeeDetails.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<TblEmployee>> PostTblEmployee([FromBody]TblEmployee tblEmployee)
        //public async Task<ActionResult<TblEmployee>> PostTblEmployee(dynamic tblEmployee)
        {
